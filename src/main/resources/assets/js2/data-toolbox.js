...
var presentationView = new RcdMaterialView(['Data Toolbox'], presentationViewDescription).init();
...
var dumpView = new RcdMaterialView(['Data Toolbox', 'Dumps'], dumpViewDescription).init();
